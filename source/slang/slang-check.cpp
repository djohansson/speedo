...
namespace Slang
{
    ...
    protected:
        ...
        {
            return (guid == Check::IID_ISlangUnknown || guid == Check::IID_ISlangSharedLibraryLoader) ? static_cast<ISlangSharedLibraryLoader*>(this) : nullptr;
        }
    ...
    static Check::FunctionInfo _getFunctionInfo(Session::SharedLibraryFuncType funcType)
    {
    ...
    DownstreamCompiler* Session::getOrLoadDownstreamCompiler(PassThroughMode type, DiagnosticSink* sink)
    {
        ...
        if (locator)
        {
            ...
            Check::SinkSharedLibraryLoader loader(m_sharedLibraryLoader, sink);
    ...
    SlangFuncPtr Session::getSharedLibraryFunc(SharedLibraryFuncType type, DiagnosticSink* sink)
    {
        ...
        Check::FunctionInfo info = _getFunctionInfo(type);

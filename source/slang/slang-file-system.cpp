...
{
    return (guid == SlangFileSystem::IID_ISlangUnknown || guid == SlangFileSystem::IID_ISlangFileSystem ) ? static_cast<ISlangFileSystem*>(this) : nullptr;
}
...
{
    if (uuid == SlangFileSystem::IID_SlangCacheFileSystem)
    {
        *outObject = this;
        return SLANG_OK;
    }

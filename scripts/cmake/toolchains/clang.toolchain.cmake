...
set(LLVM_TOOLS_BINARY_DIR $ENV{LLVM_TOOLS_BINARY_DIR} CACHE PATH "LLVM tools binary directory")
...
if(NOT (DEFINED ${CMAKE_CROSSCOMPILING} AND ${CMAKE_CROSSCOMPILING}))
	...
	if (NOT DEFINED ${CMAKE_SYSTEM_NAME}) # causes CMAKE_CROSSCOMPILING? https://github.com/microsoft/vcpkg/discussions/48436

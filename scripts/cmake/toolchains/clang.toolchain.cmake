...
#
	...
	if (NOT DEFINED CMAKE_SYSTEM_PROCESSOR OR CMAKE_SYSTEM_PROCESSOR STREQUAL "")
		set(CMAKE_SYSTEM_PROCESSOR ${CMAKE_HOST_SYSTEM_PROCESSOR} CACHE STRING "Target system processor")
	endif()
	if (NOT DEFINED CMAKE_SYSTEM_NAME OR CMAKE_SYSTEM_NAME STREQUAL "") # causes CMAKE_CROSSCOMPILING? https://github.com/microsoft/vcpkg/discussions/48436
		set(CMAKE_SYSTEM_NAME ${CMAKE_HOST_SYSTEM_NAME} CACHE STRING "Target system name")
	endif()
	if (NOT DEFINED CMAKE_SYSTEM_VERSION OR CMAKE_SYSTEM_VERSION STREQUAL "")
		set(CMAKE_SYSTEM_VERSION ${CMAKE_HOST_SYSTEM_VERSION} CACHE STRING "Target system version")
	endif()
#endif()
...
set(CMAKE_C_COMPILER_LINKER_ID LLD CACHE INTERNAL "")
set(CMAKE_C_COMPILER_LINKER_FRONTEND_VARIANT "GNU" CACHE INTERNAL "")
set(CMAKE_C_COMPILER_VERSION "${CMAKE_MATCH_1}" CACHE INTERNAL "")
set(CMAKE_C_STANDARD_COMPUTED_DEFAULT 23 CACHE INTERNAL "")
set(CMAKE_C_EXTENSIONS_COMPUTED_DEFAULT FALSE CACHE INTERNAL "")
...
set(CMAKE_CXX_COMPILER_LINKER_ID LLD CACHE INTERNAL "")
set(CMAKE_CXX_COMPILER_LINKER_FRONTEND_VARIANT "GNU" CACHE INTERNAL "")
set(CMAKE_CXX_COMPILER_VERSION "${CMAKE_MATCH_1}" CACHE INTERNAL "")
set(CMAKE_CXX_STANDARD_COMPUTED_DEFAULT 23 CACHE INTERNAL "")
set(CMAKE_CXX_EXTENSIONS_COMPUTED_DEFAULT FALSE CACHE INTERNAL "")
...
set(CMAKE_AR ${LLVM_TOOLS_BINARY_DIR}/llvm-ar${CMAKE_EXECUTABLE_SUFFIX} CACHE FILEPATH "Path to archiving tool")
set(CMAKE_RC_COMPILER ${LLVM_TOOLS_BINARY_DIR}/llvm-rc${CMAKE_EXECUTABLE_SUFFIX} CACHE FILEPATH "Path to rc compiler")
set(CMAKE_NM ${LLVM_TOOLS_BINARY_DIR}/llvm-nm${CMAKE_EXECUTABLE_SUFFIX} CACHE FILEPATH "Path to nm tool")
set(CMAKE_OBJDUMP ${LLVM_TOOLS_BINARY_DIR}/llvm-objdump${CMAKE_EXECUTABLE_SUFFIX} CACHE FILEPATH "Path to objdump")
...
set(CMAKE_C_USING_LINKER_MODE FLAG CACHE INTERNAL "")
set(CMAKE_CXX_USING_LINKER_LLD "-fuse-ld=lld" CACHE INTERNAL "")
set(CMAKE_CXX_USING_LINKER_MODE FLAG CACHE INTERNAL "")
...
elseif (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
	...
	set(CMAKE_C_STANDARD_LIBRARIES_INIT "-lc")
	set(CMAKE_CXX_STANDARD_LIBRARIES_INIT "-lc++ -lc++abi")
	set(LINK_FLAGS "${LINK_FLAGS} -Wl,-rpath,\"${LLVM_ROOT}/lib\"")
	# macOS provides pthread symbols through libc/libSystem; do not force -pthread or -lpthread.
...
#set(CMAKE_TRY_COMPILE_TARGET_TYPE "STATIC_LIBRARY") suggested as a workaround for unwanted compiler detection, but does not work it seems :(

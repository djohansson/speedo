...
set(CLANG_LINK_COMMON_FLAGS "-fuse-ld=lld -Wl,--undefined-version -lc++ -lc++abi")
set(CMAKE_EXE_LINKER_FLAGS "${CLANG_LINK_COMMON_FLAGS}")
set(CMAKE_MODULE_LINKER_FLAGS "${CLANG_LINK_COMMON_FLAGS}")
set(CMAKE_SHARED_LINKER_FLAGS "${CLANG_LINK_COMMON_FLAGS}")
#set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -L ${LLVM_PATH}/lib -L ${LLVM_PATH}/lib/c++ -Wl,-rpath,${LLVM_PATH}/lib -Wl,-rpath,${LLVM_PATH}/lib/c++")

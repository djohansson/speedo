...
set(CLANG_C_FLAGS "")
set(CLANG_CXX_FLAGS "")
# set(CLANG_C_FLAGS "-nostdinc")
# set(CLANG_CXX_FLAGS "-nostdinc++")
set(LINK_COMMON_FLAGS "-fuse-ld=lld")
set(LINK_COMMON_FLAGS_DEBUG "")
set(LINK_COMMON_FLAGS_RELEASE "")

if(CMAKE_SYSTEM_NAME MATCHES "Windows")
	set(CLANG_COMMON_FLAGS "${CLANG_COMMON_FLAGS} -Xclang -cfguard")
	set(LINK_COMMON_FLAGS_DEBUG "-Wl,-nodefaultlib:libcmtd -lmsvcrtd")
	set(LINK_COMMON_FLAGS_RELEASE "-Wl,-nodefaultlib:libcmt -lmsvcrt")
else()
	set(CLANG_CXX_FLAGS "${CLANG_CXX_FLAGS} -stdlib=libc++")
	set(LINK_COMMON_FLAGS "${LINK_COMMON_FLAGS} -lc++ -lc++abi")
...
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "${LINK_COMMON_FLAGS_DEBUG}")
set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${LINK_COMMON_FLAGS_RELEASE}")
set(CMAKE_MODULE_LINKER_FLAGS "${LINK_COMMON_FLAGS}")
set(CMAKE_MODULE_LINKER_FLAGS_DEBUG "${LINK_COMMON_FLAGS_DEBUG}")
set(CMAKE_MODULE_LINKER_FLAGS_RELEASE "${LINK_COMMON_FLAGS_RELEASE}")
set(CMAKE_SHARED_LINKER_FLAGS "${LINK_COMMON_FLAGS}")
set(CMAKE_SHARED_LINKER_FLAGS_DEBUG "${LINK_COMMON_FLAGS_DEBUG}")
set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${LINK_COMMON_FLAGS_RELEASE}")

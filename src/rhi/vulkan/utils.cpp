...
VkResult checkFlipOrPresentResult(VkResult result)
{
	...
	case VK_SUBOPTIMAL_KHR:
		std::cerr << "warning: flip/present returned VK_SUBOPTIMAL_KHR\n";
		break;
	case VK_ERROR_OUT_OF_DATE_KHR:
		std::cerr << "warning: flip/present returned VK_ERROR_OUT_OF_DATE_KHR\n";
		break;
	case VK_NOT_READY:
		std::cerr << "warning: flip/present returned VK_NOT_READY\n";
		break;
	default:
